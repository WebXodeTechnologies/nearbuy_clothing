...
export const adminStats = {
  ...
  recentStores: ${JSON.stringify(
    storesList.slice(0, 4).map((s) => ({
      id: s.id,
      name: s.name,
      owner: "Store Owner",
      location: s.location,
...
fs.writeFileSync(
  path.join(__dirname, "..", "app", "data", "dummy-data.js"),
  dummyDataJs,
);
console.log(
  "Successfully updated app/data/dummy-data.js with nearbuy.xlsx stores!",
);
