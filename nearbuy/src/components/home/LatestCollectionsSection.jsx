      ...
      <div className="w-full max-w-7xl 2xl:max-w-360 3xl:max-w-[1600px] 4xl:max-w-[2000px] 5xl:max-w-[2400px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 lg:mb-16">
          ...
          <p className="mt-3.5 text-base sm:text-lg text-gray-600 font-body leading-relaxed max-w-2xl mx-auto">
            Discover fresh designer drops, seasonal lookbooks, and exclusive
            clothing collections available in Namakkal store inventories right
            now.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {collections.map((coll, idx) => (
            ...
            >
              {/* 🔄 Updated to a refined rectangular aspect ratio (aspect-16/10 or aspect-4/3) */}
              <div className="w-full aspect-16/10 sm:aspect-4/3 relative overflow-hidden bg-gray-100 shrink-0">
                <img
                  src={coll.image}
                  alt={coll.name}
