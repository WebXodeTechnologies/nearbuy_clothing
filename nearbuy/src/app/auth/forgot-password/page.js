...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Calls your Resend-backed forget-password API route (with 'e')
      ...
      // Safely read response text first to handle any server text/HTML/error responses
            ...
            {!message && (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  isLoading={isLoading}
                  className="w-full mt-2 bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 rounded-xl transition-all shadow-md shadow-purple-600/20"
                >
                  Send Reset Details
                </Button>
              </form>
